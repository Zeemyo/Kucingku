...
class ArtikelController extends Controller
{
  ...
  public function search(Request $request)
  {
    ...
    $searchartikel = $request->get('search');
    $list_artikel = artikel::where('title', 'LIKE', '%' .$searchartikel. '%')->paginate(2);

    return view('artikel.index', compact('title', 'list_artikel', 'searchartikel'));
  }
